...
docker build -t 127.0.0.1:30400/puzzle:$BUILD_TAG --build-arg http_proxy=$http_proxy --build-arg https_proxy=$https_proxy -f applications/puzzle/Dockerfile applications/puzzle
